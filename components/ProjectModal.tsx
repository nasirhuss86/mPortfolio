...
const projectData: Record<string, ProjectData> = {
  "project-01": {
    ...
    no: "project-01",
    liveLink: "https://ai-station.vercel.app/",
    githubLink: "https://github.com/nasirhuss86/ai-station",
    hasReadme: true,
    readme: {
      title: "AI Station - All-in-One AI Platform",
      content:
        "A powerful all-in-one AI platform that brings together the best of artificial intelligence for content creation, image generation, and productivity tools. Built with modern web technologies to provide a seamless user experience. Tech Stack: React, Vite, Tailwind CSS, Lucide React, React Router, Node.js, Express.js, PostgreSQL, Gemini AI, ClipDrop API.",
    },
  },
  "project-02": {
    title: "PDF-Genius",
    ...
    githubLink: "https://github.com/nasirhuss86/PDF-Genuis",
    hasReadme: true,
    readme: {
  ...
  "project-03": {
    ...
    no: "project-03",
    liveLink: null,
    githubLink: "https://github.com/nasirhuss86/pitch-deck-analyzer",
    hasReadme: true,
    readme: {
  ...
  "project-04": {
    ...
    no: "project-04",
    liveLink: null,
    githubLink: "https://github.com/nasirhuss86/gmail-mcp",
    hasReadme: true,
    readme: {
...
export default function ProjectModal({
  ...
  useEffect(() => {
    const handleEscape = (e: KeyboardEvent) => {
      if (e.key === "Escape") {
        // Close README popup if open, otherwise close main modal
        if (readmeOpen) {
          setReadmeOpen(false);
        } else {
          onClose();
